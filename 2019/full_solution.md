...
19年的题目出的真的不错，但网上没有发现比较完整的题目解析，一般只能找到些AC的代码，但这些代码的可读性也不好。同时官方的解析和视频有些地方比较模糊甚至是错的，所以在写完了19年的所有题目后，打算写一篇2019年world final的完全的题解。解析全部有代码配对，代码也是详细注释过的，欢迎各位查看，互相学习指正。代码链接https://github.com/CptJack2/icpc-challenge/tree/master/2019
